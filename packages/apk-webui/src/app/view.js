export function collectAppElements(root = document) {
  return {
    ...
    brandAppIconFace: root.querySelector("[data-brand-app-icon-face]"),
    topbarActions: root.querySelector(".topbar-actions"),
    mobileBottomControls: root.querySelector("#mobile-bottom-controls"),
    ...
    topbarGithubLink: root.querySelector(".topbar-github-link"),
    ...
    linkClearButton: root.querySelector("#link-clear-button"),
    ...
    historyViewGroup: root.querySelector("#history-view-switch"),
    historyViewButtons: [...root.querySelectorAll("[data-history-view-mode]")],
